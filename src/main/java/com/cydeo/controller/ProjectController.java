...
public class ProjectController {
    ...
    public ResponseEntity<ResponseWrapper> getProjects() {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Projects are successfully retrieves", projectDTOList, HttpStatus.OK));
    }
    ...
    @RolesAllowed("Manager")
    public ResponseEntity<ResponseWrapper> deleteProject(@PathVariable("id") String projectcode) {
